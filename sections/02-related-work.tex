...
In this section we will look how the paradigm of landlside segmentation on martain surface has evolved overtime. We discuss the transition from traditional mapping to deep learning in \cref{sec:planetary}, followed by an analysis of the Self Supervised learning methods and world models in \cref{sec:SSL} and \cref{sec:Jepa}. We end this section by a deep theoretical overview of the current archictures that are most commonly used for segmentation.

\cref{sec:planetary} explains hwo planetary blah lahsdkjhsbd
...
\label{label: Advancement in Semenatic Segmentation}

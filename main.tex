...
\def\bmvcPaperID{\submissionId} % *** Enter the BMVC Paper ID here
\def\confName{BMVC}
\def\confYear{2026}
...
%%%%%%%%% TITLE - PLEASE UPDATE
\title{\paperTitle}  % **** Enter the paper title here
...
\begin{figure}
	\vspace{-0.2em}
	\begin{center}
		\input{figures/gflops-size-comp.tex}
	\end{center}
	\vspace{-1.5em}
	\caption{Comparison of model performances with complexity in GFLOPs}\label{fig:gflops-size-comp}
\end{figure}


\input{sections/tables/ssl-seg-miou-std.tex}

\input{sections/rebuttal/reviewer-01.tex}
\input{sections/rebuttal/reviewer-02.tex}
...
%
% The author rebuttal is optional and, following similar guidelines to previous BMVC conferences, is meant to provide you with an opportunity to rebut factual errors or to supply additional information requested by the reviewers.
